<template>
  <div class="favorites-section">
    <h2 class="favorites-title">My Favorite Prompts</h2>
    
    <div v-if="favoritePrompts.length === 0" class="no-favorites">
      <p>You haven't saved any favorite prompts yet.</p>
      <p>Click on "Save to Favorites" on any prompt card to add it here.</p>
    </div>
