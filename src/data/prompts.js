...
export const templateCategories = [
  {
    ...
    icon: '🔗',
    name: 'n8n Workflows',
    description: 'Ready-to-use n8n automation templates for common business processes and integrations. Many more available in the AI Captains Skool community.'
  }
];
