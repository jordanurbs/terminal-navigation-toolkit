...
export const promptCategories = [
  ...
  },
  {
    ...
    icon: '🐞',
    name: 'Debugging',
    description: 'Prompts & templates to help you identify and fix issues in your code with AI assistance.'
  },

  {
    ...
    icon: '📝',
    name: 'Documentation',
    description: 'Prompts & templates for generating documentation, README files, and code comments.'
  }
];
...
export const templateCategories = [
  ...
  },
  {
    ...
    description: 'Zapier automation templates for connecting apps and automating tasks.'
  },
  {
    id: 'make-automation',
    icon: '🎯',
    name: 'Make.com Workflows',
    description: 'Make.com (formerly Integromat) templates for complex automation scenarios.'
  },
  {
    id: 'general-automation',
    icon: '🤖',
    name: 'General Automation',
    description: 'Platform-agnostic automation concepts and workflow templates.'
  }
];
...
export const templates = [
  {
    ...
    platform: 'n8n',
    tags: ['rss', 'ai', 'telegram', 'content-aggregation', 'automation'],
