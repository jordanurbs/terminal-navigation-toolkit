...
export const commands = [
  ...
  },
  {
    ...
    description: "Delete a file (Windows native)",
    businessApplication: "Clean up files via Command Prompt",
    example: {
      input: "del temp.txt",
      output: "(deletes file)"
    },
  ...
  },
  {
    ...
    description: "Remove folder and contents (Windows native)",
    businessApplication: "Clean up folders via Command Prompt",
    example: {
      input: "rmdir /s /q old-folder",
      output: "(removes folder and contents)"
    },
    osSupport: ["windows-cmd", "windows-powershell"],
    difficulty: "intermediate",
    warning: "Permanently deletes folder without confirmation"
  },
